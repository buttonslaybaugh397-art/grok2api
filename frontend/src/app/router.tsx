...
import { DeferredAccountsPage, DeferredApiDocsPage, DeferredAppShell, DeferredClientKeysPage, DeferredDashboardPage, DeferredModelsPage, DeferredRequestAuditsPage, DeferredSettingsPage, DeferredStudioPage } from "@/app/deferred-pages";
...
export const router = createBrowserRouter([
  ...
  { path: "/studio", element: <DeferredStudioPage /> },
  {
